...
--[[
    ...
    Хоткей: E
    Телепортирует за спину ближайшего игрока и поворачивает лицом к цели
]]--
...
-- Телепортация за спину цели с поворотом лица к цели
local function tpBehind(targetPlayer)
    ...
    -- Устанавливаем персонажа в эту позицию и поворачиваем лицом к цели (смотрим в спину)
...
-- Обновляем ссылку на персонажа после смерти/респавна (не обязательно, но для надёжности)

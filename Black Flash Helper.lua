...
-- Создаём основной ScreenGui (изначально скрыт)
...
-- Приветственное сообщение "Press P"
local welcomeGui = Instance.new("ScreenGui")
welcomeGui.Name = "PressPMessage"
...
print("Black Flash Helper загружен! Нажмите P, чтобы открыть.")
